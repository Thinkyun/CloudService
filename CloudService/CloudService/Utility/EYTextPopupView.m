...
#pragma mark -
-(void)resetFrame :(NSString *)leftTitle{
    ...
    {
        if ([leftTitle isEqualToString:@""]) {
           CGRect rightBtnFrame = CGRectMake((kAlertWidth - kSingleButtonWidth) * 0.5, CGRectGetMaxY(self.tvContent.frame)+kContentBottomMargin, kSingleButtonWidth, kButtonHeight);
